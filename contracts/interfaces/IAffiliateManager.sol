...
interface IAffiliateManager {
    struct Affiliate {string affiliateLink;uint256 percentage;}
    function setupAffiliate(address affiliate, string calldata affiliateLink, uint256 percentage) external returns (bool);
