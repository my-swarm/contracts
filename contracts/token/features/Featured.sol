...
contract Featured is IFeatured, Pausable, Freezable, Ownable {
   ...
   */
  function freezeAccount(address account) external enabled(AccountFreezing) onlyOwner {
   ...
   */
  function unfreezeAccount(address account) external enabled(AccountFreezing) onlyOwner {
